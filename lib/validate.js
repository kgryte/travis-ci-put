...
function validate( opts, options ) {
	...
	if ( options.hasOwnProperty( 'data' ) ) {
		...
		if ( !isString( opts.data ) && !isObject( opts.data ) ) {
			return new TypeError( 'invalid option. `data` option must be either a string primitive or a JSON object. Option: `' + opts.data + '`.' );
		}
	}
